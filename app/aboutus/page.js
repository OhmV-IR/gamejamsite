...
export default function AboutUs() {
    return (
        <div>
            ...
            <h2 className={styles.text}>As a non-profit organization, we strive to educate and inspire young minds to learn, create, and play by providing them with a platform to showcase their problem-solving skills through our game jam.</h2>
            ...
            <div className="row">
                <div className="col">
                    <div className={styles.personcard}>
                        <div className="card">
                            <Image src="./Vishnu.jpg" alt="A portrait of Vishnu"></Image>
                ...
                <div className="col">
                    <div className={styles.personcard}>
                        <div className="card">
                            <Image src="./Aryaman.jpeg" alt="A portrait of Aryaman"></Image>
                            <div className="card-body">
            ...
            <div className="row">
                <div className="col">
                    <div className={styles.personcard}>
                        <div className="card">
                            <Image src="./Jared.png" alt="A portrait of Jared"></Image>
                            <div className="card-body">
                ...
                <div className="col">
                    <div className={styles.personcard}>
                        <div className="card">
                            <Image src="./Adrien.png" alt="A portrait of Adrien"></Image>
                            <div className="card-body">
